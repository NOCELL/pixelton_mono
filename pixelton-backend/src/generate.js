...
const createKeyPair = async () => {
  ...
  console.log("Public key", TonWeb.utils.bytesToHex(keyPair2.publicKey));
  console.log("Secret key", TonWeb.utils.bytesToHex(keyPair2.secretKey));
};
...
const createWallet = async (keyPair) => {
  ...
  console.log("Adress", address.toString(true, true, true)); // print address in default format. In 99% of cases this format is used in UI applications.
